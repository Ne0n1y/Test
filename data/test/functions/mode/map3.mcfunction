scoreboard players set map globaldata 3
tellraw @a ["Выбранная карта - Ковбойский городок"]
tellraw @a ["\n\nВыбор режима\n"]
...
tellraw @a {"text":" - Гонка вооружений","color": "green","clickEvent": {"action": "run_command","value": "/scoreboard players set mode globaldata 4"}}
